    ...
    <div class="w-full">
        <div class="border-2 border-dashed rounded-xl p-12 text-center transition-all duration-300 cursor-pointer"
            :class="isDragging
                ...
                : 'border-gray-300 bg-gray-50 hover:border-blue-500 hover:bg-blue-50'" @drop.prevent="handleDrop"
            ...
            <div class="flex flex-col items-center gap-4">
                ...
                <label class="cursor-pointer">
                    ...
                    <span
                        class="inline-block px-6 py-3 bg-blue-500 text-white font-semibold rounded-lg transition-all duration-300 hover:bg-blue-600 hover:-translate-y-0.5 hover:shadow-lg">
                        ファイルを選択
                    </span>
                </label>
            </div>
        ...
        <div v-if="fileName" class="flex items-center gap-3 mt-4 p-4 bg-gray-100 rounded-lg">
            <svg class="w-6 h-6 text-blue-500 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
